...
这个项目不是从零重写通用爬虫，而是基于开源项目 MediaCrawler 做业务化二次开发：把“采集公开评论”逐步改造成服务于 ToB 销售的评论整理、去重和人工判断触达工作台。
...
- 为行业需求配置抖音视频相关度分析所需的行业词、场景词和排除词；
- 保留评论 ID、父评论 ID、内容 ID、公开主页等定位字段；
- 使用 SQLite 按平台与评论 ID 做增量去重；
- 为人工判断提供评论原文、定位字段、去重结果和技术排除记录。
...
| 工作产出 | 公开评论整理、行业搜索配置、SQLite 去重、人工审核触达工作台 | — |
| 阶段验证 | 小红书/抖音采集路径、去重与人工审核流程曾在本地运行 | 尚未证明完整自动筛选或稳定规模化运行 |
